...
<head>
  ...
  <title>Teams and Conditions</title>
            ...
            <div class="col-md-12">
              ...
              <div class="search-field">
                <div class="field-group">
                  <label for="teams-conditions-content">Teams and Conditions Content</label>
                  <textarea name="" id="teams-conditions-content" class="form-control"></textarea>
                </div>
              </div>
