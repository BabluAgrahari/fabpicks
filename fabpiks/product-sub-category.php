...
<head>
    ...
    <title>Products Sub Category</title>
...
<body>
    <div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="layout">
          ...
          <div class="row">
            <div class="col-md-12">
              <h4 class="page-title">Products Sub Category</h4>
            </div>
            <form action="#">
              <div class="row">
                <div class="col-md-2">
                  <div class="field-group">
                    ...
                    <input type="text" id="sub-category-name" class="form-control">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="field-group">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg ">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="productcategoryLabel">Products Sub Category</h1>
