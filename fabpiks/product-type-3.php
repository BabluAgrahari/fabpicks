        ...
        <div class="layout">
            ...
            <main class="content product-type">
                ...
                <div class="container product-type ">
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="page-title">Product Type 3</h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="field-group">
                                        <label for="trial-point">Trial Point</label>
                                        <input type="text" id="trial-point" class="form-control" placeholder="1-6" required>
                                    </div>
                                </div>
