    ...
    <div class="card-header ">
        <div class="row">
            ...
            <div class="col-md-6" style="text-align: right;">
                <a href="<?php echo e(url('crm/product')); ?>" class="btn btn-warning btn-sm">
                    <?php if (isset($component)) { $__componentOriginalf7b6b6c4bc4eccc8de0185d678bdf3c8197f591f = $component; } ?>
<?php $component = App\View\Components\Icon::resolve(['type' => 'back'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?> Back
    ...
    <div class="card-body">
        <div class="row">
            <form id="saveProduct" action="<?php echo e(url('crm/product')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                        ...
                        <div class="row">
                            <div class="field-group col-md-6">
                                ...
                                <select name="brand_id" id="product-brand" class="form-select js-example-basic-single">
                                    ...
                                    <option value="<?php echo e($val->_id); ?>"><?php echo e(ucwords($val->name)); ?></option>
                            ...
                            <div class="field-group col-md-6">
                                ...
                                <select name="sub_category" id="sub_category" class="form-select js-example-basic-single">
                                    ...
                                    <option value="<?php echo e($val->_id); ?>"><?php echo e(!empty($val->Category->name)?ucwords($val->Category->name):''); ?>/<?php echo e(ucwords($val->name)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                        ...
                        <div class="row">
                            <div class=" col-md-6 field-group">
                                ...
                                <select name="no_feedback" id="product-feedback-form" class="form-select js-example-basic-single">
                                    ...
                                    <?php $__currentLoopData = $survay; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($val->type=='no_feedback'): ?>
                                    <option value="<?php echo e($val->_id); ?>"><?php echo e(ucwords($val->title)); ?></option>
                                    <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="col-md-6 field-group">
                                ...
                                <select name="pre_qulifing_question" id="pre-qulifing-questions" class="form-select js-example-basic-single">
                                    ...
                                    <?php $__currentLoopData = $survay; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($val->type=='pre_qulifing_question'): ?>
                                    <option value="<?php echo e($val->_id); ?>"><?php echo e(ucwords($val->title)); ?></option>
                                    <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                <div class="box-body"><img src="<?php echo e($res->thumbnail ?? defaultImg('150x100')); ?>" class="img-fluid" alt=""></div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 field-group">
                            ...
                            <select name="inventory[0][attribute]" id="attribute" option='0' class="form-select attribute">
                                <option value="">Select</option>
                                <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val->_id); ?>"><?php echo e(ucwords($val->name)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button type="submit" id="save" class="btn btn-success"> <?php if (isset($component)) { $__componentOriginalf7b6b6c4bc4eccc8de0185d678bdf3c8197f591f = $component; } ?>
...
<?php endif; ?>Add</button>
                        <button type="reset" class="btn btn-danger"> <?php if (isset($component)) { $__componentOriginalf7b6b6c4bc4eccc8de0185d678bdf3c8197f591f = $component; } ?>
...
<script>
    ...
    $(document).on('change', '.attribute', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('crm/sub-attributes')); ?>/" + attribute_id,
            type: "GET",
            dataType: "JSON",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('crm.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fabpic-git\resources\views/crm/product/create.blade.php ENDPATH**/ ?>