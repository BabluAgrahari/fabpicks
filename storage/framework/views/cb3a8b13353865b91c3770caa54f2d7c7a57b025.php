<div class="row mb-2" id="filter" <?= (empty($filter)) ? "style='display:none'" : "" ?>>
    <div class="col-md-12 ml-auto">
        <form action="<?php echo e(url('crm/survay')); ?>">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    ...
                    <a href="<?php echo e(url('crm/survay')); ?>" class="btn btn-danger btn-sm mt-2"><i class="fas fa-eraser"></i>&nbsp;Clear</a>
                </div>
            </div>
        </form>
    </div>
</div><?php /**PATH C:\xampp\htdocs\fabpic-git\resources\views/crm/survay/filter.blade.php ENDPATH**/ ?>