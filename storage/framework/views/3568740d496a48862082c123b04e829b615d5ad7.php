    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container-flude">
          ...
          <form name="form1" id="saveSingleChoise" action="<?php echo e(url('crm/survay-question')); ?>" enctype="multipart/form-data" class="custom-form">
            <?php echo csrf_field(); ?>
        ...
        html += `<div id="Single_Choise" class="size_chart">
                  <div class="feedback-container">
                    ...
                    <div class="feedback-options mt-4">
                      ...
                      <div class="form-check">
                      <button type="submit" class="btn btn-sm btn-success" id="saveBtn" id="singleChoice"><?php if (isset($component)) { $__componentOriginalf7b6b6c4bc4eccc8de0185d678bdf3c8197f591f = $component; } ?>
...
<?php endif; ?>Save</button>
  ...
  //   var selector = $(this);
  //   $.ajax({
  //     url: "<?php echo e(url('crm/edit-question')); ?>/" + id,
  //     type: "GET",
  //     dataType: 'JSON',
  //     success: function(res) {
  ...
  //   })
  // })
</script><?php /**PATH C:\xampp\htdocs\fabpic-git\resources\views/crm/survay/survayQuestion.blade.php ENDPATH**/ ?>