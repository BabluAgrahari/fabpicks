    ...
    <div class="card-header ">
        <div class="row">
            ...
            <div class="col-md-3 product-btn-group d-flex justify-content-end">
                ...
                <?php endif; ?>
                <a href="<?php echo e(url('crm/attribute-export')); ?><?php echo e(!empty($_SERVER['QUERY_STRING'])?'?'.$_SERVER['QUERY_STRING']:''); ?>" class="btn btn-sm btn-success" id="">
...
<?php endif; ?> Add
    ...
    <div class="card-body">
        <?php echo $__env->make('crm.attribute.filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="row">
            <div class="col-md-12 ">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="container">
                    <div id="message"></div>
                    <form id="SaveAttribute" action="<?php echo e(url('crm/attribute')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div id="put"></div>
                        <div class="row">
...
<?php unset($__componentOriginalf7b6b6c4bc4eccc8de0185d678bdf3c8197f591f); ?>
<?php endif; ?>Add`);
        $('form#SaveAttribute').attr('action', '<?php echo e(url("crm/attribute")); ?>');
        $('#put').html('');
...
<?php endif; ?>Add`;
    ...
    $(document).on('click', '.edit', function(e) {
        ...
        let url = "<?php echo e(url('crm/attribute')); ?>/" + id + "/edit";
        $.ajax({
            url: url,
            type: 'GET',
            dataType: 'JSON',
...
<?php unset($__componentOriginalf7b6b6c4bc4eccc8de0185d678bdf3c8197f591f); ?>
<?php endif; ?>Update`);
                    $('form#SaveAttribute').attr('action', '<?php echo e(url("crm/attribute")); ?>/' + id);
...
<?php echo $__env->make('crm.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fabpic-git\resources\views/crm/attribute/list.blade.php ENDPATH**/ ?>