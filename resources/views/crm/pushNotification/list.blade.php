...
<div class="card">
    <div class="card-header ">
        <div class="row">
            <div class="col-md-9">
                <h5><x-icon type="list" />Push Notification</h5>
            </div>
            <div class="col-md-3 ">
    ...
    <div class="card-body">
        @include('crm.pushNotification.filter')
        <div class="row">
            <div class="col-md-12 ">
                <div class="table-responsive">
                    <table class="table products-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">{{++$key}}</th>
                                <td>{{ucWords($list->user_group)}}</td>
                                <td>{{ucWords($list->subject)}}</td>
                                <td>{{ucWords($list->notification)}}</td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-6" id="pushNotificationLabel">Add Push Notification</h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="field-group">
                                ...
                                <textarea name="notification" id="notification" placeholder="Notification Body" class="form-control"></textarea>
                            </div>
